...
public class Task4_Exam {
    ...
    public static Map<TruckType, List<Truck>> groupTrucksByType(List<Truck> trucks) {
        return trucks.stream().collect(Collectors.groupingBy(t -> getTypeByWeight(t.maxWeightKg)));
    }
    ...
    public static Map<TruckType, Long> countTrucksByType(List<Truck> trucks) {
            return trucks.stream().collect(Collectors.groupingBy(t -> getTypeByWeight(t.maxWeightKg), Collectors.counting()));
    }
